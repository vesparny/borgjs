...
It will send you reports and it will write detailed logs you can anytime look at.
...
* backup creation
* prune old backup according to a set of rules declared in the config file.
...
* lockfile system pased on PID in order to avoid concurrent backups to the same destination
* logs to a different file details about the backup session such as borg output, commands executed and so on
* highly [configurable](#configuration)

## Notifications

borgjs supports a wide range of notifications, besides detailed logs.
...
Running a backup is as easy as
...
I personally use [cronnix](https://www.macupdate.com/app/mac/7486/cronnix) to schedule my backup sessions.
...
* I personally use [http://rsync.net/](rsync.net) for my backup, they also apply [dirty cheap](http://www.rsync.net/products/attic.html) pricing model to borg users.
